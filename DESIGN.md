...
| `pkg/specialists` | Subagent-as-tool: `.specialist.md` files (YAML frontmatter plus a prose body — not Go templates; renamed from `.tmpl` in v0.8, #292) with budgets, model overrides, tool allowlists ([`docs/specialists-design.md`](./docs/specialists-design.md)). |

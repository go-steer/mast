...
Current release: **v0.1.0-pre** (pre-release — see the [roadmap](/roadmap/)
for what's still gated).

## Release tarballs

Each release ships cross-compiled tarballs plus a `checksums.txt`
(SHA-256). Assets for v0.1.0-pre:

- `mast_0.1.0-pre_linux_amd64.tar.gz`
- `mast_0.1.0-pre_linux_arm64.tar.gz`
- `mast_0.1.0-pre_darwin_amd64.tar.gz`
- `mast_0.1.0-pre_darwin_arm64.tar.gz`
- `checksums.txt`
...
```sh
curl -fsSLO https://github.com/go-steer/mast/releases/download/v0.1.0-pre/mast_0.1.0-pre_linux_amd64.tar.gz
curl -fsSLO https://github.com/go-steer/mast/releases/download/v0.1.0-pre/checksums.txt
sha256sum --check --ignore-missing checksums.txt
tar -xzf mast_0.1.0-pre_linux_amd64.tar.gz

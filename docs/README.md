...
| CopilotKit + `@copilotkit/bot-*` gives mast Slack/Teams/Discord/Telegram/WhatsApp integration for free (once mast speaks AG-UI); OpenTag is the reference Slack bot pattern | [`./ag-ui-design.md`](./ag-ui-design.md) |

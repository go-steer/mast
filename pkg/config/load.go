...
// yields zero entries. Takes no logger: the .tmpl deprecation warning
// this used to raise became a LoadDir error in v0.9 (#349), so the one
// thing here that needed one is now carried by the error itself.
